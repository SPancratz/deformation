...
#define mat_ctx_t ctx_t
#define __mat_ctx_struct __ctx_struct
...
static void mat_ctx_init_long(ctx_t ctx)
{
...
static void mat_ctx_init_mpq(ctx_t ctx)
{
...
static void mat_ctx_init_fmpz_poly_q(ctx_t ctx)
{
...
static void mat_ctx_clear(ctx_t ctx)
    { }
